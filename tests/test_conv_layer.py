...
def conv2d_backward(gy, w, kernel_size, kernel_depth, stride, num_groups):
    ...
    def test_conv2d_layer(self):
        ...
        for _ in np.arange(200):
            ...
            for _ in np.arange(5):
                ...
                # reference calculation ...
                gx, w = conv2d_backward(gy, w, kernel_size, kernel_depth, stride, groups)

                # layer backward pass ...
                gx_ref = layer.backward(gy)
